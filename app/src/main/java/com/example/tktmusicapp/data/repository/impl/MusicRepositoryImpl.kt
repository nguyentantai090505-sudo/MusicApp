...
class MusicRepositoryImpl @Inject constructor(private val api: SpotifyApiService) : MusicRepository {
    ...
    override suspend fun getNewReleases() = safeCall {
        api.getNewReleases(SpotifyTokenManager.getToken())
    }

    override suspend fun getArtistTopTracks(artistId: String) = safeCall {
        api.getArtistTopTracks(SpotifyTokenManager.getToken(), artistId)
    }
